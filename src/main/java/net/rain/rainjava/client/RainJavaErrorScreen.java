...
public class RainJavaErrorScreen
extends Screen {
    ...
    protected void init() {
        ...
        openLog.active = Files.exists(RainJavaLogger.logFile(this.scriptType), new LinkOption[0]);
    ...
    public void render(@NotNull GuiGraphics g, int mx, int my, float delta) {
        ...
        String title = "RainJava " + this.scriptType.getName() + " script " + (isError ? "errors" : "warnings");
    ...
    private void openLogFile() {
        Path log = RainJavaLogger.logFile(this.scriptType);
    ...
    extends ObjectSelectionList<ErrorEntry> {
        ...
        public ErrorList(RainJavaErrorScreen screen, Minecraft mc, int width, int height, int y0, int y1, List<ScriptError> lines) {
    ...
    extends ObjectSelectionList.Entry<ErrorEntry> {
        ...
        private void openFile() {
            ...
            Path base = FMLPaths.GAMEDIR.get().resolve("RainJava").resolve(this.line.scriptType.getName()).resolve(this.line.fileName);
